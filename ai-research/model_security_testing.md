...
- **[Mirage](https://github.com/bad-antics/mirage)** - Adversarial machine learning framework in Julia. Implements evasion attacks (FGSM, PGD, C&W), model extraction, membership inference, and robustness testing. 7,000+ lines of Julia code.
