# Lesson 6-7: Agent Skills and Harnesses

> Student follow-along resources, key concepts, and references for this sublesson.

## Overview

Lesson 6 established how agents **reason**, **use tools** (including via MCP), stay **human-governed** (HITL), and **normalize data**. This closing sublesson connects that stack to how practitioners ship agents day to day: **Agent Skills** package reusable, portable expertise for assistants, and a **harness** is the engineered runtime around the model—policies, tools, verification, and project context—that turns raw LLM capability into something dependable in a codebase or workflow.
...
- Relate skills and harness design to Lesson 6 themes (MCP tools, HITL, data contracts).
...
A mature harness also encodes **verification**: linters, tests, diff review, human approvals (Lesson 6-5), and "stop conditions" so autonomy does not run unbounded.
...
Skills sit in the **context supply chain**: they teach *how* to use tools and interpret results; MCP exposes *what* can be called; data transformation (Lesson 6-6) ensures arguments and observations stay shaped and safe.
...
Skills and harness thinking are how teams scale agent adoption: repeatability, reviewability, and bounded autonomy. Together with models, prompting, safety, data fluency, coding workflows, MCP, HITL, and data transformation, you have the full practitioner arc for designing agentic systems responsibly.
